/**
 * A generated module for PocDaggerDenoOtelNode functions
 *
 ...
 * if appropriate. All modules should have a short dqescription.
 */
import { dag, Directory, func, object } from "@dagger.io/dagger";

@object()
export class PocDaggerDenoOtelNode {
  /**
  ...
  async runDenoServer(src: Directory): Promise<void> {
    ...
    await this.denoContainer(src, otelEndpoint)
